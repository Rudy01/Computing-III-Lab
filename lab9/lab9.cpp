...
public:
  ...
  double payAdvice() {
    double twoWeekPay = getSalary() / 26.0;
    return twoWeekPay;
  }
...
public:
  ...
  double payAdvice() {
    double twoWeekPay = getHourlyRate() * 40.0;
    return twoWeekPay;
  }
...
public:
  ...
  double payAdvice() {
    double twoWeekPay = getFeePerCourse() / 7.0;
    return twoWeekPay;
  }
...
public:
  ...
  ~PartTime() { cout << "Partime destructor called\n"; }
...
ostream& operator<< (ostream& out, const EmployeeKind& e) {
  out << "Employee Kind (no member variables used)" << endl;
  return out;
}
...
int main(void) {
  ...
  Adjunct a1("James", "Willis", "1 Cider Road", 56485241, "001-23-8374", "Math", 2, 1000, 10);
  double a1TwoWeekPay = a1.payAdvice();
  cout << "Adjunct a1 (James...):\n" << a1 << "Two Week Pay:\t" << a1TwoWeekPay << endl << endl;
  ...
  Grader g1("John", "Doe", "89 Canal Street", 54329876, 3.5, "CS", "Tom Wilkes", "junior",
	    "COMP.2010", 25.00);
  double g1TwoWeekPay = g1.payAdvice();
  cout << "Grader g1(John...):\n" << g1 << "Two Week Pay:\t" << g1TwoWeekPay << endl << endl;
  ...
  double n1TwoWeekPay = n1.payAdvice();
  cout << "NTT Faculty n1(Tom...):\n" << n1 << "Two Week Pay:\t" << n1TwoWeekPay << endl << endl;
